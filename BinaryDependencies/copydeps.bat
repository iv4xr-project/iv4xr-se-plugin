...
copy "%source_dir%\SpaceEngineers.Game.dll"
copy "%source_dir%\SpaceEngineers.ObjectBuilders.dll"
copy "%source_dir%\System.Collections.Immutable.dll"
copy "%source_dir%\VRage.Audio.dll"
copy "%source_dir%\VRage.dll"
copy "%source_dir%\VRage.Game.dll"
copy "%source_dir%\VRage.Input.dll"
copy "%source_dir%\VRage.Library.dll"
copy "%source_dir%\VRage.Math.dll"
copy "%source_dir%\VRage.Render.dll"
