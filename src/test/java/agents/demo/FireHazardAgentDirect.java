...
public class FireHazardAgentDirect {
    ...
    public void fireHazardDemo() throws InterruptedException{
    	...
    	var testingTask = SEQ(
        		GoalLib.positionIsInCloseRange(new Vec3(6,0,5)).lift(),
                GoalLib.positionIsInCloseRange(new Vec3(7,0,8)).lift(),
                GoalLib.positionIsInCloseRange(new Vec3(7,0,11)).lift(),
                GoalLib.positionIsInCloseRange(new Vec3(5,0,11)).lift(),
                GoalLib.positionIsInCloseRange(new Vec3(5,0,16)).lift(),
                GoalLib.positionIsInCloseRange(new Vec3(2,0,16)).lift(),
                GoalLib.positionIsInCloseRange(new Vec3(1,0,18)).lift(),
                GoalLib.positionIsInCloseRange(new Vec3(3,0,20)).lift(),
                GoalLib.positionIsInCloseRange(new Vec3(6,0,20)).lift(),
