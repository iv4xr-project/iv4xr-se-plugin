...
class DictUppercaseWrapper(Dict[str, Any]):
    ...
    @staticmethod
    def wrap_if_dict(
        dict_to_wrap: Union[Dict[str, Any], "DictUppercaseWrapper"]
    ) -> Union[Dict[str, Any], "DictUppercaseWrapper"]:
...
def call_rpc(
    prefix: List[str], sock: "socket.socket", *args: List[Any], **kwargs: Any
) -> Any:
