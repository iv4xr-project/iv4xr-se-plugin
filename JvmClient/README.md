...
- Block position doesn't always have to be in center of the block. To locate center of the block, use midway between `minPosition` and `maxPosition` (extension function `centerPosition`).
