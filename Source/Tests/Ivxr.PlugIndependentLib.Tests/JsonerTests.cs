    ...
    public class JsonerTests
    {
        ...
        public void ConvertsSeObservationToJson()
        {
            ...
            Assert.Equal("{\"Velocity\":{\"X\":0.0,\"Y\":0.0,\"Z\":0.0}," +
                         ...
                         "\"Camera\":null,\"JetpackRunning\":false,\"HelmetEnabled\":true,\"Health\":0.5,\"Oxygen\":0.0,\"Hydrogen\":0.0,\"SuitEnergy\":0.0," +
                         "\"HeadLocalXAngle\":0.0,\"HeadLocalYAngle\":0.0,\"TargetBlock\":null,\"TargetUseObject\":null,\"Movement\":0,\"Id\":\"Foo\"," +
